...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribeSafeRule)
...
示例值：{ "read": "auth!= null", "write": "doc.\_openid == auth.uid" } |
