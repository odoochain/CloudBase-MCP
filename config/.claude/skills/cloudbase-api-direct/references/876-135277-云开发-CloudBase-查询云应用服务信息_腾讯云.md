...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribeCloudAppInfo)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribeCloudAppInfo。 |
...
X-TC-Action: DescribeCloudAppInfo
<公共请求参数>
...
```json
{
    "Response": {
        "AppPath": "/html",
        "CreateTime": "2026-07-29 15:11:17",
        "DeployType": "static-hosting",
        "Domain": "html-************************.***a*****clou*********",
        "Framework": "other",
        "LatestBuildTime": "2026-07-29 15:13:16",
        "LatestStatus": "******",
