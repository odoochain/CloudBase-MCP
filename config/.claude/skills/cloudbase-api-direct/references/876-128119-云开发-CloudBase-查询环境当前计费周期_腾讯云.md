...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribeEnvAccountCircle)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribeEnvAccountCircle。 |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| StartTime | String | 环境计费周期开始时间  
示例值：2025-12-01 00:00:00 |
| EndTime | String | 环境计费周期结束时间  
示例值：2025-12-31 23:59:59 |
...
X-TC-Action: DescribeEnvAccountCircle
<公共请求参数>
...
| ResourceUnavailable.ResourceExpired | 资源已到期 |