...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=cynosdb&Version=2019-01-07&Action=CreateAccounts)
...
| InvalidParameterValue.AccountAlreadyExistError | 账号已存在。 |
