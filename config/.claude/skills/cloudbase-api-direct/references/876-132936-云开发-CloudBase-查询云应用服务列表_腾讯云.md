...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribeCloudAppList)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribeCloudAppList。 |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| ServiceList | Array of [CloudAppServiceItem](/document/api/876/34822#CloudAppServiceItem) | 
服务列表
...
X-TC-Action: DescribeCloudAppList
<公共请求参数>
