...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribeEnvPlans)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribeEnvPlans。 |
| Version | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：2018-06-08。 |
| Region | 否 | String | [公共参数](/document/api/876/34812) ，本接口不需要传递此参数。 |
| PackageId | 否 | String | 
套餐英文标识，不指定则返回所有可售卖套餐

枚举值：

-   baas\_integration： 集成版
-   baas\_personal： 个人版
-   baas\_pf\_standard： 标准版
-   baas\_pf\_enterprise： 企业版
-   baas\_pf\_enterprise\_senior： 企业高级版
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| PlanList | Array of [PlanInfo](/document/api/876/34822#PlanInfo) | 
云开发新套餐详情
