...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribeCloudBaseRunBuildLog)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribeCloudBaseRunBuildLog。 |
...
| ServiceVersion | 否 | String | 版本名称 |
| BuildId | 否 | Integer | 构建ID |
| Start | 否 | Integer | 偏移记录 |

## 3\. 输出参数

| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| Log | [CloudBaseRunBuildLog](/document/api/876/34822#CloudBaseRunBuildLog) | 日志  
...
```
https://tcb.tencentcloudapi.com/?Action=DescribeCloudBaseRunBuildLog
