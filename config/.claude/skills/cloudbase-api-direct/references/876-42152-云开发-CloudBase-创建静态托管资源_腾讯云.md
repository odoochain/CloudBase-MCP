...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=CreateStaticStore)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：CreateStaticStore。 |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| Result | String | 创建静态资源结果(succ/fail)  
示例值：succ |
...
```
https://tcb.tencentcloudapi.com/?Action=CreateStaticStore
