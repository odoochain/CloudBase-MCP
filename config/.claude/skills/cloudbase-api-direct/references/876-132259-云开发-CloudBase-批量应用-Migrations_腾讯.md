...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=PushPGUserMigrations)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：PushPGUserMigrations。 |
...
示例值：5000 |
| StatementTimeoutMs | 否 | Integer | 

单条 SQL 执行最长时间，超过后由 PostgreSQL 取消该语句
...
X-TC-Action: PushPGUserMigrations
<公共请求参数>
