...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribeCloudAppCosInfo)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribeCloudAppCosInfo。 |
...
示例值：vue |
| DeployType | 是 | String | 部署类型  
示例值：static-hosting |
| UnixTimestamp | 否 | String | 时间戳  
示例值：1709500000 |
| Suffix | 否 | String | 文件后缀  
示例值：.zip |
| NeedDownload | 否 | Boolean | 是否需要下载  
示例值：false |
...
示例值：https://xxx.cos.xxxx.myqcloud.com/home/xxxx/static-0a94df-react-xxxx.zip?q-sign-algorithm=sha1&q-ak=xxxxxxx&q-sign-time=xxxxxx&q-key-time=177xxxxx&q-header-list=host&q-url-param-list=&q-signature=xxxxxxxxxxx01sjjdhsd1190 |
| UploadHeaders | Array of [KVPair](/document/api/876/34822#KVPair) | 上传header |
| DownloadUrl | String | 下载链接  
示例值：https://xxx.cos.xxxx.myqcloud.com/xxx/static.zip?q-signature=xxxxxxxxxxx01sjjdhsd1190 |
...
X-TC-Action: DescribeCloudAppCosInfo
<公共请求参数>
