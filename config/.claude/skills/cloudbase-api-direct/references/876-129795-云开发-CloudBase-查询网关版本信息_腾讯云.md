...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribeGatewayVersions)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribeGatewayVersions。 |
| Version | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：2018-06-08。 |
| Region | 否 | String | [公共参数](/document/api/876/34812) ，本接口不需要传递此参数。 |
| EnvId | 是 | String | 环境id  
示例值：env-test |
| GatewayId | 是 | String | 网关id  
示例值：gw-xxx |
| VersionName | 否 | String | 版本名  
示例值：versionName-xxx |
...
示例值：gw-xxx |
| TotalCount | Integer | 版本总数  
示例值：1 |
| GatewayVersionItems | Array of [GatewayVersionItem](/document/api/876/34822#GatewayVersionItem) | 版本信息详情 |
...
X-TC-Action: DescribeGatewayVersions
<公共请求参数>
