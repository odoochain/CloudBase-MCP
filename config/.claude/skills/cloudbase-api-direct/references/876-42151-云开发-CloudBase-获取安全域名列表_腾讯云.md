...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribeAuthDomains)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribeAuthDomains。 |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| Domains | Array of [AuthDomain](/document/api/876/34822#AuthDomain) | 安全域名列表 |
...
```
https://tcb.tencentcloudapi.com/?Action=DescribeAuthDomains
&EnvId=test-23
&<公共请求参数>
```
