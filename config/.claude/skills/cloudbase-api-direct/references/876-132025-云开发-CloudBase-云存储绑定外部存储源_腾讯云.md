...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=BindStorageSource)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：BindStorageSource。 |
| Version | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：2018-06-08。 |
| Region | 否 | String | [公共参数](/document/api/876/34812) ，本接口不需要传递此参数。 |
| EnvId | 是 | String | 环境ID  
示例值：cloudbase-0gx36sm8ddc58be0 |
| StorageConfig | 是 | [ExternalStorage](/document/api/876/34822#ExternalStorage) | 存储源 |
...

{
    ...
    "StorageConfig": {
        "Enabled": true,
        "BucketName": "tencent-cos-bucket-1257619089",
        "Region": "ap-shanghai",
        "BasePath": "cloudbase-env-v1"
    }
}
```
