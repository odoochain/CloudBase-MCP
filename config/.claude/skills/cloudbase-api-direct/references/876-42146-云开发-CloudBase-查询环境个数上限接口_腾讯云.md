...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribeEnvLimit)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribeEnvLimit。 |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| MaxEnvNum | Integer | 环境总数上限  
示例值：1 |
| CurrentEnvNum | Integer | 目前环境总数  
示例值：1 |
| MaxFreeEnvNum | Integer | 免费环境数量上限  
示例值：1 |
| CurrentFreeEnvNum | Integer | 目前免费环境数量  
示例值：1 |
| MaxDeleteTotal | Integer | 总计允许销毁环境次数上限  
示例值：1 |
| CurrentDeleteTotal | Integer | 目前已销毁环境次数  
示例值：1 |
| MaxDeleteMonthly | Integer | 每月允许销毁环境次数上限  
示例值：1 |
| CurrentDeleteMonthly | Integer | 本月已销毁环境次数  
示例值：1 |
| MaxFreeTrialNum | Integer | 微信网关体验版可购买月份数  
示例值：1 |
| CurrentFreeTrialNum | Integer | 微信网关体验版已购买月份数  
示例值：0 |
| ChangePayTotal | Integer | 转支付限额总数  
示例值：0 |
| CurrentChangePayTotal | Integer | 当前已用转支付次数  
示例值：0 |
| ChangePayMonthly | Integer | 转支付每月限额  
示例值：0 |
| CurrentChangePayMonthly | Integer | 本月已用转支付额度  
示例值：0 |
...
```
https://tcb.tencentcloudapi.com/?Action=DescribeEnvLimit
&Source=miniapp
&<公共请求参数>
```
