...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=CreateHostingDomain)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：CreateHostingDomain。 |
...
```
https://tcb.tencentcloudapi.com/?Action=CreateHostingDomain
&EnvId=env_id
&Domain=domain
&CertId=cert-id
&<公共请求参数>
