...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribeStaticStore)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribeStaticStore。 |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| Data | Array of [StaticStoreInfo](/document/api/876/34822#StaticStoreInfo) | 静态托管资源信息  
...
```
https://tcb.tencentcloudapi.com/?Action=DescribeStaticStore
