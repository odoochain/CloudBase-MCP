...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=CreateAuthDomain)
...
```
https://tcb.tencentcloudapi.com/?Action=CreateAuthDomain
&EnvId=envid
&Domains.0=localhost
&<公共请求参数>
```
